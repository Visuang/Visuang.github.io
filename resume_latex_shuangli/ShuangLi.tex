...
围绕多模态视觉智能与跨模态表征学习开展研究，已在 IJCV、TIFS、TNNLS、TCSVT、PR 等国际权威期刊以及 ICML、AAAI、ACM MM 等 CCF-A 类会议发表论文10余篇，其中第一作者发表 ICML、TIFS、PR、TNNLS 等高水平论文。Google Scholar 引用数 = 710，H 指数 = 15（截至2026年9月）。更多信息请查看\href{https://scholar.google.com/citations?user=ePe0rG4AAAAJ&hl=zh-CN}{谷歌学术主页}。\\
